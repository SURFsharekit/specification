...
Our [issue tracker](https://github.com/surfsharekit/specification/issues) can be used to discuss problems or additions to the current or next version of the Open Education API specification.
...
* The spec must comply with the [SURFsharekit API Specification v2.0](https://github.com/SURFsharekit/specification)
